<template>
  <div class="text-center pt-12">
    ...
    <form class="w-96 mt-8 mx-auto">
      ...
      <button
        type="button"
        class="inline-flex items-center px-4 py-2 mt-4 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
        @click="sendTokens"
      >
        <svg
...
export default defineComponent({
  ...
  setup() {
    ...
    const destinationTokenAddress = import.meta.env.VITE_DESTINATION_TOKEN_ADDRESS
