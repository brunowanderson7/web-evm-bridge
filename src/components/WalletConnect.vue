<template>
  <div class="flex justify-center">
    ...
    <button
      ...
      :class="walletStore.address == '' ? 'hover:bg-gray-600' : ''"
      @click="connectWallet()"
      class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-gray-500"
    >
      <svg
